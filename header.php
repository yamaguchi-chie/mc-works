      ...
      <div class="header__inner">
        <div class="header__body">
          ...
          <h1 class="header__logo">
            <a href="<?php echo esc_url(home_url()); ?>"><img src="<?php echo get_template_directory_uri(); ?>/dist/assets/images/common/logo.webp" alt="mc-worksのロゴを表した画像" width="" height="" loading="lazy" decoding="async"></a>
          </h1>
          <!-- PCナビメニュー -->
